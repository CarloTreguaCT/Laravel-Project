...
<script>
    ...
    <script src="<?php echo e(url('js/landing.js')); ?>" defer></script>
    ...
    <div class="wrapper">
        ...
        <div class="form-box register">
            ...
            <form method="post" name = "registration">
                ...
                <div class="input-box">
                    <span class="icon"><ion-icon name="mail"></ion-icon></span>
                    <input type="text" required name="r_email" value='<?php echo e(old("email")); ?>'>
                    <label>Email</label>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\HomeWork\resources\views/register.blade.php ENDPATH**/ ?>